<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="miA2.aspx.cs" Inherits="WebApplication3.miA2" %>
...
<img src="<%#Eval("product_images")%>" height="300" width="200">
    ...
    <asp:Button ID="Button3" runat="server" Text="Buy Now" OnClick="Button2_Click" Height="56px" Width="230px" BackColor="#FD9026" />
    <asp:Button ID="Button2" runat="server" Text="Review" OnClick="Button1_Click" CommandName="WebForm4" CommandArgument='<%# Eval("id")%>'  Height="56px" Width="230px" BackColor="#FF2C65" />      
    </a>
    </div>
</ItemTemplate>
</asp:Repeater>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT [Username], [Id], [Product_name], [Review_Status], [Review] FROM [Product_Review]">
    </asp:SqlDataSource>

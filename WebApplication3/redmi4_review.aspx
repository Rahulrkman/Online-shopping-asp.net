<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="redmi4_review.aspx.cs" Inherits="WebApplication3.redmi4_review" %>
...
<body>
        ...
        <center>
            <asp:Label ID="Label1" runat="server" Font-Bold="True" 
                Font-Names="Pristina" Font-Size="X-Large" Text="Review Form"></asp:Label>
            <br />
            <br />

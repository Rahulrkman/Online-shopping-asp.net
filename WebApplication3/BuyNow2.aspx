<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BuyNow2.aspx.cs" Inherits="WebApplication3.BuyNow2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contentbody" runat="server">
    ...
    function forRentClicked(sender) {       
        var tb1 = document.getElementById('<%= txtadd.ClientID %>');
        
        tb1.style.display = sender.checked ? 'inline' : 'none';
        
    }
    function forRentClicked1(sender) {
        var controls = document.getElementById("<%=Panel3.ClientID%>").getElementsByTagName("input");
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="200px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" Width="944px">
                    ...
                    <asp:Panel ID="Panel3" runat="server">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td class="style2">&nbsp;</td>
                                <td>
                                    <asp:TextBox ID="txtadd" runat="server" CssClass="txt" TextMode="MultiLine" 

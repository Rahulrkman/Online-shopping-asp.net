<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="xiomi.aspx.cs" Inherits="WebApplication3.xiomi" %>
...
<img src="<%#Eval("product_images")%>?id=<%#Eval("id") %>" height="300" width="200">
</a>
</div>

...
{
    public partial class lenovoIdeaPadReview : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String SQL = "SELECT name,price FROM laptop where id=6";
            ...
            {
                Label12.Text = login.Tables[0].Rows[0]["name"].ToString();

...
namespace eval
{
    public partial class REVIEWMCQ : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        if (Count >= 3)
                        {
                            Label10.Text = "Good Review";
                        }
                        else
                        {
                            Label10.Text = "Bad Review";
                        }

                        SqlCommand cmd5 = con.CreateCommand();
                        cmd5.CommandType = CommandType.Text;
                        cmd5.CommandText = "INSERT INTO Product_Review(Username,Product_name,E_mail,mac_add,Q1,Q2,Q3,Q4,Q5,Review,Review_Status) VALUES('" + Session["username"] + "','" + Label12.Text + "','" + Label8.Text + "',@mac,@Q1,@Q2,@Q3,@Q4,@Q5,@review,'" + Label10.Text + "')";
        ...
        private Boolean checkuser()
        {
            ...
            String myquery = ("Select E_mail,Username from Product_Review where E_mail='" + Label8.Text + "' and Username='" + Session["Username"] + "'");
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = myquery;
            cmd.Connection = con;
